...
public:
	...
	//uint8_t	DotX(void) { return dotX; }
	//uint8_t	DotY(void) { return dotY; }
	//uint8_t	GapX(void) { return gapX; }
	//uint8_t	GapY(void) { return gapY; }
	uint8_t	CharW(void) { return dotX + gapX; }
	uint8_t	CharH(void) { return dotY + gapY; }
